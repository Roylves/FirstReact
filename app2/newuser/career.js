...
export default class Newcareer extends Component {
render() {
    return (
              ...
              {/* use flexGrow to avoid overlap with image flex */}
                <View style={{flexGrow: 0.5}}>
                    <Text style={styles.title}>
                        Where would you like to pursue your career?
                    </Text>
                    <TextInput
                    placeholder="state of place"
                ...
                <View style={{flex: 1}}>
                    <TouchableOpacity 
                    style={styles.buttonContainer} onPress={Actions.tabbar}>
